      ...
      (:body 
       ...
       (:div :style "clear:both"
             (:div :style "float:left"
                   (who:fmt "This is Phoros version ~A " (phoros-version))
                   (:a :href "http://phoros.berlios.de" (:img :src "/phoros-lib/public_html/phoros-logo-plain.png" :height 30 :style "vertical-align:middle" :alt "Phoros"))
                   ...
                   :br
                   (who:fmt "Phoros is implemented using Steel Bank Common Lisp (version ~A)" (lisp-implementation-version))
                   (:a :href "http://www.sbcl.org" (:img :src "http://www.sbcl.org/sbclbutton.png" :height 30 :style "vertical-align:middle" :alt "SBCL"))
