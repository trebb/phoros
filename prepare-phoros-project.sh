...
./phoros --create-user=ahr                                      \
         --user-password=ahr --user-full-name="Andreas Heine"   \
         --user-role=read                                       \
         --presentation-project=my_presentation_project         \
         $pg_credentials
./phoros --create-user=tl                                       \
         --user-password=tl --user-full-name="Thomas Lehmann"   \
         --user-role=write                                      \
         --presentation-project=my_presentation_project         \
         $pg_credentials
./phoros --create-user=bb                                               \
         --user-password=bb --user-full-name="Bert Burgemeister"        \
         --user-role=admin                                              \
         --presentation-project=my_presentation_project                 \
         $pg_credentials
...
./phoros --create-aux-view=my_presentation_project                      \
         ...
         --numeric-column=nk-station                                    \
         --text-column=vnk --text-column=nnk --text-column=strasse      \
         $pg_aux_credentials
...
do
    ./phoros --store-images-and-points=this_acquisition_project         \
             --directory=$i/ --common-root=/path/to/all/projects/       \
             $pg_credentials
done
