...
./phoros --create-user=ah --user-password=ah --user-full-name="Andreas Heine" --user-role=admin --presentation-project=my_presentation_project  $pg_credentials
./phoros --create-user=ahw --user-password=ahw --user-full-name="Andreas Heine" --user-role=write --presentation-project=my_presentation_project  $pg_credentials
...
./phoros --create-user=tl --user-password=tl --user-full-name="Thomas Lehmann" --user-role=admin --presentation-project=my_presentation_project  $pg_credentials
...
../calib-storage.sh my_db_server phoros_workspace some_db_user 'wonttell'
